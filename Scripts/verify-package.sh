...
test -f "$CONTENTS/TuckNote.app/Contents/Resources/LICENSE"
...
test -f "$CONTENTS/TuckNote.app/$HIGHLIGHTER_RESOURCES/atom-one-light.css"
test -f "$CONTENTS/TuckNote.app/$HIGHLIGHTER_RESOURCES/atom-one-dark.css"
